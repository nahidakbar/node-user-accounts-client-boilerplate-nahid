...
var showProfileView = exports.showProfileView = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(accounts, parent) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            _context.prev = 13;
            for (_iterator2 = fields.filter(function (field) {
  ...
  return function showProfileView(_x2, _x3) {
...
function emailLogin(accounts, parent, method, callback, options) {
  ...
  td = tr.Td('');
  var passwordlessLogin = td.Button(options.loginLinkPrefix ? 'Send me a magic link' : 'Send me a one time password');
  ...
  passwordlessLogin.OnClick(function () {
    accounts.loginPasswordless(method, getParams()).then(function (x) {
          ...
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              allUsers.forEach(function (user) {
                ...
                tr.Td(Object.keys(user.roles).filter(function (r) {
                  return user.roles[r];
                }).join(', '));
                var td = tr.Td();
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              list.Display('none');
              sub.Display('').clear();
              Object.keys(options.newUserTypes).forEach(function (type_) {
                sub.H2("Create New User With " + options.newUserTypes[type_] + ":");
                var inputCredential = sub.InputText().Placeholder("Enter new " + type_ + " here:");
                sub.Button('Create').OnClick(_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 9:
                ...
                _context4.prev = 15;
                for (_iterator3 = fields.filter(function (field) {
