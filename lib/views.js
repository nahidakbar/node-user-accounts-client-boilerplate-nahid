...
var showProfileView = exports.showProfileView = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(accounts, parent) {
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              Object.keys(options.newUserTypes).forEach(function (type_) {
                ...
                sub.Button('Create').OnClick(_asyncToGenerator(regeneratorRuntime.mark(function _callee5() {
